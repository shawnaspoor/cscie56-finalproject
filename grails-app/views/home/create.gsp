...
<html>
	...
	<body>
		<a href="#create-home" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-home" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:homeInstance, action:'save']"  enctype="multipart/form-data">
				<fieldset class="form">
