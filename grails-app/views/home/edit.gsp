...
<html>
	...
	<body>
			...
			<h3>Edit ${homeInstance.propertyTitle}</h3>
			...
			<g:form url="[resource:homeInstance, action:'update']" method="POST"  enctype="multipart/form-data">
				<g:hiddenField name="version" value="${homeInstance?.version}" />
				<fieldset class="form">
